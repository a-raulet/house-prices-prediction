...
There is a third file on the website called `data_description`, which gives details on every variable, and can also be found in the GitHub repository we have just downloaded or here : [link](https://github.com/a-raulet/house-prices-prediction/blob/master/data_description.txt).
...
We clean the validation set the same way we did for the train set. Most of the NAs are the same in both sets. So we won't get in the details as we can find the full code below or in the .R file from the GitHub repository we have downloaded (or the following link containing the .R code for this project : [link](https://github.com/a-raulet/house-prices-prediction/blob/master/house%20prices%20code.R)).
